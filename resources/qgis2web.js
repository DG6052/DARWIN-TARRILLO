...
map.getView().fit([-49341.240375, 8312904.118294, 1216033.178790, 8727026.655475], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">AYACUCHO GEOIDE</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (16 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = '@ DARWIN CHAVEZ ';
            }
